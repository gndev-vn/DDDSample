...
namespace OrderingAPI.Domain.Migrations
{
    ...
    [Migration("20260404082704_AddCustomersAndOrderCustomerSnapshots")]
    partial class AddCustomersAndOrderCustomerSnapshots
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderingAPI.Domain.Entities.CategoryCache", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("OrderingAPI.Domain.Entities.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OrderingAPI.Domain.Entities.OrderLine", b =>
                {
                    b.HasOne("OrderingAPI.Domain.Entities.Order", "Order")
                        .WithMany("Lines")
                        .HasForeignKey("OrderId")
