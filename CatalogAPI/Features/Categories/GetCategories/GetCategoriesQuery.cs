    ...
    : IRequestHandler<GetCategoriesQuery, List<CategoryModel>>
{
    ...
    private static IQueryable<Category> ApplyFilters(IQueryable<Category> categories,
    ...
    private static IQueryable<Category> ApplySorting(IQueryable<Category> query, string searchSlug)
    {
